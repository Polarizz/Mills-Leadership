...
function _iterableToArrayLimit(e, t) {
    if ("undefined" != typeof Symbol && Symbol.iterator in Object(e)) {
        var n = [],
            ...
            i = !1,
            o = void 0;
        try { for (var a, l = e[Symbol.iterator](); !(r = (a = l.next()).done) && (n.push(a.value), !t || n.length !== t); r = !0); } catch (e) { i = !0, o = e } finally { try { r || null == l.return || l.return() } finally { if (i) throw o } }
        return n
    }
}
...
function _defineProperty(e, t, n) { return t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e }! function() {
    function n(e) { return ["elInY+elHeight", "elCenterY-".concat(e = 0 < arguments.length && void 0 !== e ? e : 30), "elCenterY", "elCenterY+".concat(e), "elOutY-elHeight"] }
    var l, u, s, _, P, I, t = {
            fadeInOut: function(e, t) { t = 1 < arguments.length && void 0 !== t ? t : 0; return { opacity: [n(0 < arguments.length && void 0 !== e ? e : 30), [t, 1, 1, 1, t]] } },
            fadeIn: function(e, t) {
                return {
                    opacity: [
            ...
            blurInOut: function(e, t) { t = 1 < arguments.length && void 0 !== t ? t : 20; return { blur: [n(0 < arguments.length && void 0 !== e ? e : 100), [t, 0, 0, 0, t]] } },
            blurIn: function(e, t) {
                return {
                    blur: [
                        ["elInY+elHeight", 0 < arguments.length && void 0 !== e ? e : "elCenterY"],
            ...
            scaleInOut: function(e, t) { t = 1 < arguments.length && void 0 !== t ? t : .6; return { scale: [n(0 < arguments.length && void 0 !== e ? e : 100), [t, 1, 1, 1, t]] } },
            ...
            spin: function(e, t) {
                ...
                return {
                    rotate: [
                        [0, e],
                        [0, 1 < arguments.length && void 0 !== t ? t : 360], { modValue: e }
                    ]
                }
            },
            flipX: function(e, t) {
    ...
    function d(e, t, n) {
        ...
        var l = document.body.scrollHeight,
            ...
            a = a + d,
            d = a + i;
        return Function("return ".concat(e.replace(/screenWidth/g, s).replace(/screenHeight/g, c).replace(/pageHeight/g, l).replace(/pageWidth/g, u).replace(/elWidth/g, r).replace(/elHeight/g, i).replace(/elInY/g, a - c).replace(/elOutY/g, d).replace(/elCenterY/g, a + i / 2 - c / 2).replace(/elInX/g, t - s).replace(/elOutX/g, o).replace(/elCenterX/g, t + r / 2 - s / 2).replace(/index/g, n)))()
    }

    function i(e, t) {
        var n = this,
            r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
        _classCallCheck(this, i), _defineProperty(this, "getValueFn", void 0), _defineProperty(this, "name", ""), _defineProperty(this, "lastValue", 0), _defineProperty(this, "frameStep", 1), _defineProperty(this, "m1", 0), _defineProperty(this, "m2", 0), _defineProperty(this, "inertia", 0), _defineProperty(this, "inertiaEnabled", !1), _defineProperty(this, "getValue", function(e) { var t = n.lastValue; return e % n.frameStep == 0 && (t = n.getValueFn()), n.inertiaEnabled && (e = t - n.lastValue, n.m1 = .8 * n.m1 + e * (1 - .8), n.m2 = .8 * n.m2 + n.m1 * (1 - .8), n.inertia = Math.round(5e3 * n.m2) / 15e3), n.lastValue = t, [n.lastValue, n.inertia] }), this.name = e, this.getValueFn = t, Object.keys(r).forEach(function(e) { n[e] = r[e] }), this.lastValue = this.getValueFn()
    }
        ...
        _classCallCheck(this, f), _defineProperty(this, "domElement", void 0), _defineProperty(this, "transformsData", void 0), _defineProperty(this, "styles", {}), _defineProperty(this, "selector", ""), _defineProperty(this, "groupIndex", 0), _defineProperty(this, "laxInstance", void 0), _defineProperty(this, "onUpdate", void 0), _defineProperty(this, "update", function(e, t) {
            ...
            for (n in r) {
                ...
                for (a in o) {
                    var c, d = _slicedToArray(o[a], 3),
                        ...
                        m = void 0 === m ? "" : m,
                        w = I[w];
                    t % v == 0 && (w = function(e, t, n, r) { var i = 0; if (e.forEach(function(e) { e < n && i++ }), i <= 0) return t[0]; if (i >= e.length) return t[e.length - 1]; var o, a = (a = e[o = i - 1], e = e[i], (n - a) / (e - a)); return r && (a = r(a)), o = t[o], t = t[i], o * (1 - (a = a)) + t * a }(f, h, g ? u % g : u, w), d && (c = s * d, "absolute" === p && (c = Math.abs(c)), w += c), c = "px" == (m || _.includes(a) ? "px" : P.includes(a) ? "deg" : "") ? 0 : 3, c = w.toFixed(c), i[a] = y ? y(c, b.domElement) : c + m)
                }
            }
            ...
            for (e in b.transformsData) ! function(e) {
                ...
                (void 0 === t ? [] : t).forEach(function(e) {
                    ...
                    n ? (t = n(i, e), Object.keys(t).forEach(function(e) { o[e] = t[e] })) : console.error("Lax preset cannot be found with name: ", r)
                }), delete o.presets;
                for (var n in o) ! function(e) {
                    var t = _slicedToArray(o[e], 3),
                        ...
                        r = c(r, l).map(function(e) { return d(e, i, b.groupIndex) }),
                        n = c(n, l).map(function(e) { return d(e, i, b.groupIndex) });
                    a[e] = [r, n, t]
                }(n);
                b.transforms[e] = a
            }(e)
        }), _defineProperty(this, "applyStyles", function(e) {
            var r, i, o, t = (r = e, i = { transform: "", filter: "" }, o = { translateX: 1e-5, translateY: 1e-5, translateZ: 1e-5 }, Object.keys(r).forEach(function(e) {
                var t = r[e],
            ...
            Object.keys(t).forEach(function(e) { b.domElement.style.setProperty(e, t[e]) })
        }), this.selector = e, this.laxInstance = t, this.domElement = n, this.transformsData = r, this.groupIndex = i;
        var a = void 0 === (i = o.style) ? {} : i,
            o = o.onUpdate;
        Object.keys(a).forEach(function(e) { n.style.setProperty(e, a[e]) }), o && (this.onUpdate = o), this.calculateTransforms()
    }
